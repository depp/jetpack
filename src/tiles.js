...
Tiles.prototype.init = function(r) {
	...
	this.program = shader.loadProgram(r.gl, {
		vert: 'tile.vert',
		frag: 'tile.frag',
		attributes: 'Pos TexCoord Normal Color',
		uniforms: 'MVP',
	});
};
...
Tiles.prototype.render = function(r, camera) {
	...
	gl.vertexAttribPointer(2, 4, gl.FLOAT, false, ATotal, ANormal);
	gl.enableVertexAttribArray(3);
	gl.vertexAttribPointer(3, 4, gl.UNSIGNED_BYTE, true, ATotal, AColor);
	gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, this.ibuffer);
